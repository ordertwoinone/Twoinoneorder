...
export const PERMISSION_GROUPS: {
...
}[] = [
  {
    ...
    keys: ["till", "orders", "own_orders_only", "kitchen", "availability", "inventory", "expenses", "reports"],
  },
  {
    title: "Closing up",
...
export const PERMISSION_HINT: Record<PosPermission, string> = {
  ...
  inventory: "Count the stock, book deliveries and write off breakages.",
...
const LANDING: { key: PosPermission; href: string }[] = [
  ...
  { key: "inventory", href: "/pos/inventory" },
